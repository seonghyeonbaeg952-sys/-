  ...
  return (
    ...
    >
      <div className="accompanist-profile__shell">
        ...
        <footer className="accompanist-profile__folio">{<FormattedCopy page="accompanist" id="accompanist.fixed.AccompanistProfiles.12198036a1" text={copyText("accompanist", "accompanist.fixed.AccompanistProfiles.12198036a1", "SEOUL MOTET YOUTH CHOIR · ")}>{copyText("accompanist", "accompanist.fixed.AccompanistProfiles.12198036a1", "SEOUL MOTET YOUTH CHOIR · ")}</FormattedCopy>}<SiteCopy page="accompanist" id="accompanist.accompanistProfiles.english6" fallback={"ACCOMPANIST PROFILE"} /></footer>
      </div>
    </section>
  )
}
