...
export type JoinOpenScorePresentation = 'default' | 'figma-open-score'
...
const figmaJoiningSteps = [
  {
    description: '기본 정보와 활동 희망',
    title: '지원서 작성',
  },
  {
    description: '일정과 다음 절차 안내',
    title: '보호자 연락',
  },
  {
    description: '음역과 리듬을 함께 확인',
    title: '음악 확인·상담',
  },
  {
    description: '결과와 첫 연습 일정',
    title: '첫 연습 합류',
  },
] as const

const figmaGuardianNotes = [
  '보호자 연락으로 일정 안내',
  '사진·개인정보 동의는 별도',
] as const
...
export function JoinOpenScoreCTA({
  ...
  return (
    <section
      ...
      ref={ref}
    >
      <div className="join-open-score__design-canvas">
