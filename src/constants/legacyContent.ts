...
export const legacyChoirIntro = {
  ...
  foundedYear: 2014,
  summary:
    '서울모테트청소년합창단은 기독교 정신을 바탕으로 교회음악의 가치를 배우고, 창의적인 음악교육을 통해 음악적 성장과 따뜻한 마음을 함께 길러 가는 합창단입니다.',
  mission:
...
export const legacyAboutSections = [
  ...
  },
  {
    ...
    title: '교육 목적',
    content:
      '서울모테트음악재단 청소년아카데미 부설 청소년합창단인 서울모테트청소년합창단은 다음 세대를 이끌어 갈 청소년들이 창의적인 음악교육 안에서 음악적 성장과 따뜻한 마음을 함께 길러 가도록 돕습니다.',
    display_order: 2,
    is_visible: true,
  },
  {
