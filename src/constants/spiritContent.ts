...
export const spiritManifestoCopy: SpiritManifestoCopy = {
  ...
  paragraphs: [
    ...
    '서울모테트청소년합창단은 서울모테트합창단이 오랜 시간 지켜 온 진심 어린 음악, 교회음악의 바른 이상, 작품 앞에서의 꾸준한 태도, 함께 노래하는 공동체의 정신을 다음 세대의 언어로 이어갑니다.',
  ],
}
...
export const spiritValues: SpiritValue[] = [
  {
    number: '01',
    title: '진심을 담은 음악',
    summary: '작품 앞에서 꾸준하게, 한 음 앞에서 진실하게',
    description:
      '서울모테트의 음악 정신은 악보와 작품, 가사와 메시지 앞에서 진심 어린 태도를 갖는 데서 시작됩니다. 상업적 흥행이나 과시보다 작품의 본질과 진정성을 우선하며, 청소년들은 이 과정을 통해 꾸준히 듣고 살피는 마음을 배웁니다.',
  },
  {
    number: '02',
    title: '교회음악의 바른 이상',
  ...
  },
  {
    ...
    description:
      '합창은 혼자 완성할 수 없는 예술입니다. 단원들은 서로의 호흡과 음색에 귀 기울이고, 맡은 자리를 꾸준히 준비하며, 하나의 하모니를 위해 서로를 듣고 맞추는 태도를 배웁니다. 이 경험은 공동체 안에서 자신이 필요한 존재임을 깨닫게 합니다.',
  },
  {
    number: '04',
    title: '다음 세대 교육',
    summary: '음악으로 마음을, 찬송으로 삶을 세우다',
    description:
      '서울모테트청소년합창단은 음악적 재능만을 계발하는 곳이 아닙니다. 합창을 통해 신앙과 따뜻한 마음을 지닌 다음 세대를 세우고, 예술성·공동체성·미래를 향한 꿈을 함께 길러 가는 전인적 음악교육의 장입니다.',
  },
]
...
export const homeSpiritBookletPages = [
  ...
  },
  {
    ...
    title: '진심을 담은 음악은 한 음을 오래 바라보는 마음에서 시작됩니다.',
  },
  {
...
export const legacyFlowSteps: LegacyFlowStep[] = [
  ...
  },
  {
    ...
    body:
      '서울모테트합창단 창단 25주년을 계기로 음악과 신앙, 마음의 성장을 함께 품은 다음세대 합창교육의 사명이 제도적으로 확장되었습니다.',
  },
  {
    year: '현재',
    title: '청소년 합창교육 공동체',
  ...
  },
  {
    ...
    title: '다음 세대의 울림',
    body:
      '합창은 청소년이 자신의 목소리를 발견하고, 이웃의 소리를 들으며, 세계를 향한 나눔과 평화의 꿈을 품게 하는 교육의 길이 됩니다.',
  },
]
...
export const educationJourneySteps: EducationJourneyStep[] = [
  ...
  },
  {
    ...
    body:
      '내 목소리의 크기와 색깔을 조절하며, 전체 하모니를 위해 자신의 소리를 조율하는 법을 배웁니다.',
  },
  {
    step: '약속 지키기',
    title: '한 음과 한 약속을 소중히 여깁니다',
    body:
      '악보를 꾸준히 준비하고, 연습 시간의 약속과 파트 안의 자리를 소중히 여기며 서로를 신뢰하는 태도를 기릅니다.',
  },
  {
    step: '섬기기',
    title: '무대 밖에서도 음악과 꿈을 나눕니다',
    body:
      '봉사 연주와 국제교류의 자리에서 음악이 이웃을 위로하고 공동체를 세우며, 평화와 화해의 메시지를 전하는 언어가 될 수 있음을 경험합니다.',
  },
]
...
export const conductorPhilosophyCopy: SpiritCopy = {
  ...
  body:
    '서울모테트청소년합창단의 지휘는 정확한 음악적 기량만을 요구하지 않습니다. 서로에게 귀 기울이는 태도, 약속을 소중히 여기는 마음, 작품과 신앙 앞에서의 꾸준함을 함께 가르치는 교육의 과정입니다.',
  quote:
    '높은 기준은 압박이 아니라, 꾸준한 습관과 경건한 태도를 길러 가는 성장의 길입니다.',
}
...
export const joinSpiritCopy: JoinSpiritCopy = {
  ...
  body:
    '서울모테트청소년합창단은 합창을 통해 청소년이 자신의 소리를 발견하고, 타인의 소리를 존중하며, 공동체 안에서 꾸준하고 따뜻하게 성장하도록 돕습니다.',
  points: [
    '정통 합창 레퍼토리와 교회음악을 깊이 있게 배웁니다.',
    '연습과 무대를 통해 꾸준함, 약속을 소중히 여기는 태도, 공동체성을 기릅니다.',
...
export const homeSpiritPreviewCopy = {
  ...
  ctaLabel: '합창단 정신 자세히 보기',
  expandedBody:
    '그 과정에서 음악은 기술을 넘어 마음과 신앙, 공동체성과 미래를 향한 꿈을 세우는 교육의 자리가 됩니다.',
...
export const supportImpactItems: SpiritValue[] = [
  ...
  {
    title: '다음 세대의 성장',
    description: '음악의 재능과 마음이 함께 자라는 교육 환경을 만드는 동역입니다.',
  },
]
