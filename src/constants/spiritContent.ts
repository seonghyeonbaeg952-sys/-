...
export const spiritValues: SpiritValue[] = [
  {
    ...
    description:
      '서울모테트의 음악 정신은 악보와 작품, 가사와 메시지 앞에서 진심 어린 태도를 갖는 데서 시작됩니다. 상업적 흥행이나 과시보다 작품의 본질과 진정성을 우선하며, 청소년들은 이 과정을 통해 꾸준함과 배려를 배웁니다.',
  },
  {
    number: '02',
    title: '교회음악의 바른 이상',
  ...
  },
  {
    ...
    description:
      '합창은 혼자 완성할 수 없는 예술입니다. 단원들은 서로의 호흡과 음색에 귀 기울이고, 맡은 자리를 꾸준히 준비하며, 하나의 하모니를 위해 배려와 절제를 배웁니다. 이 경험은 공동체 안에서 자신이 필요한 존재임을 깨닫게 합니다.',
  },
  {
    number: '04',
    title: '다음 세대 교육',
